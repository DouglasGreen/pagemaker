...
class PageTest extends TestCase
{
    public function testConstructor()
    {
        ...
        $this->assertEquals('MyPage', $page->getTitle());
        $this->assertEquals('en', $page->getLang());
        $this->assertEquals('UTF-8', $page->getCharset());
        $this->assertNull($page->getFavicon());
    }

    public function testSetMetaValid()
    {
        $page = new Page('MyPage');
        $page->setMeta('content-type', 'text/html');
        $this->assertEquals('text/html', $page->getMeta('content-type'));
    }

    public function testSetMetaInvalid()
    {
    ...
    {
        $page = new Page('MyPage');
        $page->setStyle('bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css', '4.3.1');
    ...
    {
        $this->expectException(ValueException::class);
        $this->expectExceptionMessage('Style "bootstrap" already set: "https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"');
        $page = new Page('MyPage');
        $page->setStyle('bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css', '4.3.1');
        $page->setStyle('bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.2/css/bootstrap.min.css', '4.3.2');
    }
}
